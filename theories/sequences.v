...
From mathcomp Require Import reals ereal itv topology normedtype landau.
...
have /le_trans -> // : `| y n - y (n + m)| <=
  ...
  pose q' := @ItvRealco R q%:num 0%Z 1%Z (!! ge0 q) q1.
  rewrite -[q%:num]/(q'%:num) -!mulrA -mulrDr ler_pM// -[q'%:num]/(q%:num).
